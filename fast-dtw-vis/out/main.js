...
electron_1.app.on("ready", () => {
    window = window_1.createMainWindow(appPath);
});
electron_1.app.on("window-all-closed", electron_1.app.quit);
//# sourceMappingURL=main.js.map
});
___scope___.file("app/window.js", function(exports, require, module, __filename, __dirname){

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.createMainWindow = exports.DIMENSIONS = void 0;
const Utils_1 = require("fuse-box/Utils");
...
function loadURL(window, appPath) {
    window.loadURL(url_1.format({
        pathname: Utils_1.joinFuseBoxPath(appPath, "out/index.html"),
        protocol: "file",
        slashes: true,
    }));
}
...
return ___scope___.entry = "app/main.js";
});
